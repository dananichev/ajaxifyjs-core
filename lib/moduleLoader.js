(function (factory) {
    ...
    return {
        ...
        init: function() {
            var self = this;
            $(document).on("block-loaded.ajaxifyjs", function(element){
        ...
        initAppModules: function(elem) {
            ...
            if (elem.is("[data-app-module]")) {
                ...
                self.parseBindings(elem).loadModule(elem, module, callback, self.binding);
            }
            ...
            elem.find("[data-app-module]").each(function() {
                ...
                self.parseBindings($this).loadModule($this, module, callback, self.binding);
            });
