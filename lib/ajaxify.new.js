(function (factory) {
    ...
    return {
        ...
        sendRequest: function(options) {
            ...
            this._requestsPool[this.requestOptions.timestamp].req = $.ajax({
                url: this.getUrl(),
                dataType: this.requestOptions.blocks,
                method: this.requestOptions.method,
                timeout: this._requestTimeout
            });

            this._requestsPool[this.requestOptions.timestamp].req.error(this.errorCallback).done(this.doneCallback);
