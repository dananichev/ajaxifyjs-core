(function (factory) {
    ...
    return {
        ...
        init: function(settings) {
            ...
            if (settings.url.length === 0 || (!settings.multipleQueries && this._requestsPool.length>0)) {
                return false;
            }
        ...
        sendRequest: function(settings) {
            ...
            this._requestsPool[this.timestamp].req.error(function(response, textStatus, errorThrown) {
                "use strict";
